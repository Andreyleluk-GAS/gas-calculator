                  ...
                  <div className="space-y-2 md:space-y-4 text-slate-900 text-slate-900 text-slate-900">
                      ...
                      <div className="flex items-end justify-between border-t border-blue-100/50 pt-2 md:pt-3 text-slate-900 text-slate-900">
                         <div className="flex flex-col text-slate-900">
                            ...
                            <p className="text-2xl md:text-3xl font-black leading-none text-blue-900 text-blue-900 leading-none">{formatMoney(passResults.costM)}</p>
                         </div>
                         <div className="flex flex-col text-right">
              ...
              <div className={`grid grid-cols-1 ${systemType === 'cng' ? 'md:grid-cols-2' : ''} gap-2 md:gap-6 mb-3 md:mb-8 font-sans text-slate-900`}>
                <div className={`bg-gradient-to-br ${truckTheme.gradient} text-white p-4 md:p-8 rounded-2xl shadow-xl flex flex-row justify-between relative overflow-hidden font-sans text-white text-white`}>
                  <div className="relative z-10 flex flex-col justify-between w-2/3 md:w-3/4 text-white text-white">
                    <div><div className="text-[9px] md:text-xs font-bold uppercase tracking-wider opacity-90 font-sans text-white text-white">Экономия (Базовый)</div><div className="text-xl md:text-5xl font-bold mb-2 md:mb-4 leading-tight font-sans text-white text-white text-white">{formatMoney(truckSummary.savings)}</div></div>
