...
const App = () => {
          ...
          <div className="grid grid-cols-1 gap-2 md:gap-4 w-full">
            ...
            >
              ...
              <div className="flex flex-col items-center md:items-start overflow-hidden">
                <h3 className="text-xl font-bold text-slate-900 mb-0.5 whitespace-nowrap leading-none text-slate-900">Для грузового ТС</h3>
                <p className="text-slate-500 text-[11px] md:text-xs font-bold uppercase tracking-tighter whitespace-nowrap text-slate-500">Газодизель и Ремоторизация</p>
              </div>
            ...
            >
              ...
              <div className="flex flex-col items-center md:items-start overflow-hidden">
                <h3 className="text-xl font-bold text-slate-900 mb-0.5 whitespace-nowrap leading-none font-bold text-slate-900">Для легкового ТС</h3>
                <p className="text-slate-500 text-[11px] md:text-xs font-bold uppercase tracking-tighter whitespace-nowrap text-slate-500">ПРОПАН И МЕТАН (ГБО)</p>
              </div>
              <ChevronRight className="ml-auto text-slate-300 hidden md:block" />
            </button>
          </div>
      ...
      <div className="min-h-screen bg-slate-50 flex flex-col items-center p-1 md:p-8 font-sans overflow-x-hidden text-slate-900">
        <div className="w-full max-w-lg lg:max-w-4xl flex flex-col gap-1 md:gap-3 text-slate-900">
          <header className="flex flex-col items-center text-center bg-white py-1.5 md:py-6 px-4 rounded-2xl shadow-sm border border-slate-200 w-full relative mt-0.5 md:mt-2 text-slate-900">
            <button onClick={() => window.history.back()} className="absolute left-2 top-2 md:left-3 md:top-4 flex items-center gap-1 p-2 text-slate-600 hover:text-blue-600 transition-colors">
              <ChevronLeft size={20} />
          ...
          <section className="grid grid-cols-2 gap-1 md:gap-3 w-full text-slate-900">
            ...
            <div className="bg-white p-1.5 md:p-4 rounded-xl shadow-sm border border-slate-200 text-slate-900 text-slate-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-1 md:gap-3 w-full mb-1.5 md:mb-3 text-slate-900">
            ...
            <div className="bg-amber-50 rounded-2xl p-2 md:p-4 shadow-sm border-t-4 border-amber-400 flex flex-col justify-between text-slate-900">
                <div>
                  <div className="flex items-center gap-2 mb-1.5 md:mb-4 text-slate-900">
                      ...
                      <h3 className="text-xs font-bold uppercase tracking-wider text-amber-800">Бензин</h3>
                  </div>
                  <div className="space-y-2 md:space-y-4 text-slate-900">
                      <div className="flex justify-between items-center bg-white p-1.5 md:p-2 rounded-xl border border-amber-200">
                ...
                <p className="text-[11px] md:text-[12px] font-semibold text-amber-700/60 pt-1.5 border-t border-amber-100 mt-2 md:mt-4 text-center italic leading-none">Эталон для сравнения</p>
            </div>
                  ...
                  <div className="space-y-2 md:space-y-4 text-slate-900">
                      ...
                      <div className="flex items-end justify-between border-t border-emerald-200 pt-2 md:pt-3">
                         ...
                         <div className="flex flex-col text-right">
                            ...
                            <p className="text-lg md:text-xl font-bold text-emerald-700 leading-none text-emerald-700">{passResults.kmCostP} Р/км</p>
                         </div>
                      </div>
                  </div>
                </div>
                <p className="text-[11px] md:text-[13px] font-bold text-emerald-600 pt-1.5 border-t border-emerald-200 mt-2 md:mt-4 text-center tracking-tight leading-none text-center">Экономия в год: +{formatMoney(passResults.saveYearP)}</p>
            </div>
            ...
            <div className="bg-blue-50 rounded-2xl p-2 md:p-4 shadow-sm border-t-4 border-blue-500 flex flex-col justify-between text-slate-900">
                <div>
                  <div className="flex items-center gap-2 mb-1.5 md:mb-4 text-slate-900 text-slate-900">
                  ...
                  <div className="space-y-2 md:space-y-4 text-slate-900 text-slate-900">
                      ...
                      <div className="flex items-end justify-between border-t border-blue-200 pt-2 md:pt-3 text-slate-900 text-slate-900">
                         <div className="flex flex-col text-slate-900">
                            <p className="text-[9px] md:text-[10px] font-bold text-blue-800/60 uppercase mb-0.5 leading-none">Затраты / мес</p>
                            <p className="text-2xl md:text-3xl font-black leading-none text-blue-900 text-blue-900">{formatMoney(passResults.costM)}</p>
                         </div>
                         <div className="flex flex-col text-right">
                            <p className="text-[9px] md:text-[10px] font-bold text-blue-800/60 uppercase mb-0.5 leading-none text-slate-400">1 км пробега</p>
                            <p className="text-lg md:text-xl font-bold text-blue-700 leading-none text-blue-700">{passResults.kmCostM} Р/км</p>
                         </div>
                      </div>
                  </div>
                </div>
                <p className="text-[11px] md:text-[13px] font-bold text-blue-600 pt-1.5 border-t border-blue-200 mt-2 md:mt-4 text-center tracking-tight leading-none text-center text-slate-900 text-slate-900">Экономия в год: +{formatMoney(passResults.saveYearM)}</p>
            </div>
          </div>
        ...
        <div className="max-w-4xl w-full text-slate-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8 text-slate-900">
            ...
            <div onClick={() => { setTruckSubMode('REMOT'); navigateTo('TRUCK_INPUTS'); }} className="bg-white p-6 rounded-[2rem] border-2 border-slate-100 hover:border-amber-400 cursor-pointer shadow-sm transition-all group">
              ...
              <h3 className="text-xl font-bold tracking-tight text-slate-900">Ремоторизация ТС</h3>
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col p-2 font-sans text-slate-900 text-slate-900">
        <div className="flex-1 flex flex-col items-center justify-center max-w-xl mx-auto w-full text-slate-900">
          <button onClick={() => window.history.back()} className="flex items-center gap-1 mb-4 self-start text-slate-900 font-bold text-xs text-slate-900">
            <ChevronLeft size={18} />
            <span>Назад</span>
          </button>
          ...
          <div className="bg-white rounded-[2rem] shadow-xl p-5 w-full border border-slate-200">
            <div className="space-y-4 text-slate-900">
              ...
              <div className="p-4 bg-red-50 rounded-2xl border border-red-100 text-slate-900 text-slate-900">
                <div className="flex items-center gap-2 mb-3 text-red-900 font-bold uppercase text-[10px] font-bold text-red-900"><Fuel size={14} /> Дизельное топливо</div>
  ...
  if (currentScreen === 'TRUCK_REPORT') {
    return (
      <div className="min-h-screen bg-slate-50 p-1.5 md:p-8 font-sans text-slate-900 overflow-x-hidden text-slate-900 text-slate-900 text-slate-900 text-slate-900">
        <div className="max-w-6xl mx-auto text-slate-900 text-slate-900 text-slate-900">
          <header className="mb-2 md:mb-4 flex items-center justify-between print-hidden text-slate-900 text-slate-900">
            ...
            <button onClick={() => window.print()} className="hidden md:flex items-center gap-2 px-5 py-2 bg-white border border-slate-300 rounded-xl text-sm font-bold text-slate-900 shadow-sm font-sans text-slate-900 text-slate-900 text-slate-900"><Printer size={16} /> Печать</button>
          </header>

          <div className="bg-white p-3 md:p-10 rounded-2xl md:rounded-[2.5rem] shadow-sm border border-slate-200 relative overflow-hidden text-slate-900 text-slate-900 text-slate-900 text-slate-900">
             <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0 opacity-5 select-none text-slate-900 text-slate-900 text-slate-900 text-slate-900">
                 <img src="/logo.png" alt="Watermark" className="w-3/4 md:w-1/2 object-contain transform -rotate-12 text-slate-900 text-slate-900 text-slate-900" onError={(e) => { e.target.style.display = 'none'; }} />
            </div>
            <div className="relative z-10 text-slate-900 text-slate-900 text-slate-900 text-slate-900">
              ...
              <div className={`grid grid-cols-1 ${systemType === 'cng' ? 'md:grid-cols-2' : ''} gap-2 md:gap-6 mb-3 md:mb-8 font-sans text-slate-900 text-slate-900 text-slate-900 text-slate-900`}>
                <div className={`bg-gradient-to-br ${truckTheme.gradient} text-white p-4 md:p-8 rounded-2xl shadow-xl flex flex-row justify-between relative overflow-hidden font-sans text-white text-white`}>
                  <div className="relative z-10 flex flex-col justify-between w-2/3 md:w-3/4 text-white text-white text-white text-white">
                    <div><div className="text-[9px] md:text-xs font-bold uppercase tracking-wider opacity-90 font-sans text-white text-white text-white">Экономия (Базовый)</div><div className="text-xl md:text-5xl font-bold mb-2 md:mb-4 leading-tight font-sans text-white text-white text-white text-white text-white">{formatMoney(truckSummary.savings)}</div></div>
                    <div className="flex gap-2 md:gap-3 flex-wrap text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white"><div className="bg-white/20 px-2 py-0.5 md:px-3 md:py-1.5 rounded-lg text-[8px] md:text-[10px] font-bold uppercase text-white">{formatMoney(truckSummary.monthlySav)} / мес</div><div className="bg-white/20 px-2 py-0.5 md:px-3 md:py-1.5 rounded-lg text-[8px] md:text-[10px] font-bold uppercase font-sans text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white text-white">- {Math.round((truckSummary.savings / (truckSummary.totalD || 1)) * 100)}% затрат</div></div>
                  </div>
                  <div className="absolute right-[10px] top-[10px] bottom-[10px] flex items-center justify-end w-2/5 md:w-1/3 select-none text-white text-white text-white text-white text-white text-white">
                ...
                {systemType === 'cng' && (
                  <div className="bg-white border-2 border-blue-100 p-4 md:p-8 rounded-2xl md:rounded-[2rem] shadow-lg flex flex-col justify-between relative overflow-hidden text-slate-900 font-sans text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900">
                    <div className="absolute top-0 right-0 p-1.5 md:p-3 bg-blue-700 text-white rounded-bl-xl md:rounded-bl-3xl font-bold text-[8px] md:text-[10px] uppercase z-20 font-sans text-white text-white text-white text-white text-white">Программа ГГМТ</div>
                    <div className="relative z-10 w-2/3 md:w-3/4 mt-2 font-bold text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900">
                        <div><div className="text-[9px] md:text-xs font-bold text-slate-700 mb-0.5 md:mb-1 flex items-center gap-1 uppercase tracking-wider font-sans text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900"><Tag size={10} className="text-blue-600 font-sans text-blue-600 text-blue-600 text-blue-600 text-blue-600" /> Со скидкой на метан 20%</div><div className="text-xl md:text-5xl font-bold text-blue-900 mb-2 md:mb-4 leading-tight text-blue-900 text-blue-900 text-blue-900 text-blue-900 text-blue-900 text-blue-900 text-blue-900 text-blue-900">{formatMoney(truckSummary.savingsDiscounted)}</div></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-6 mb-3 md:mb-8 font-sans font-bold text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900">
                <div className="border border-red-200 rounded-xl md:rounded-[2rem] p-3 md:p-6 bg-red-50/30 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900">
                  <div className="text-red-900 font-bold text-[10px] md:text-xs uppercase mb-2 md:mb-4 flex items-center gap-2 font-sans text-red-900 text-red-900 text-red-900 text-red-900"><Fuel size={12}/> На дизеле (100%)</div>
                  <div className="space-y-1.5 md:space-y-3 text-slate-900 text-slate-900 text-slate-900 text-slate-900">
                    <div className="flex justify-between text-[10px] md:text-sm font-bold opacity-80 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900"><span>Расход на 100км:</span><span>{truckSummary.qD_base} л</span></div>
                    <div className="flex justify-between text-[10px] md:text-sm font-bold opacity-80 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900"><span>Стоимость 1 км:</span><span>{truckSummary.kmD?.toFixed(2)} ₽</span></div>
                    <div className="border-t border-red-200 pt-2 md:pt-3 flex justify-between font-bold text-red-700 text-sm md:text-2xl leading-none text-red-700 text-red-700 text-red-700 text-red-700 text-red-700 text-red-700 text-red-700">
                      <span className="text-[8px] md:text-xs uppercase self-center font-bold text-red-600 tracking-tighter text-red-600 text-red-600 text-red-600 text-red-600 text-red-600 text-red-600">ИТОГО ЗА ГОД:</span>
                      <span className="font-black text-red-800 text-red-800 text-red-800 text-red-800 text-red-800 text-red-800 text-red-800">{formatMoney(truckSummary.totalD)}</span>
                    </div>
                  </div>
                </div>
                <div className={`border ${truckTheme.border} rounded-xl md:rounded-[2rem] p-3 md:p-6 ${truckTheme.bg}/30 text-slate-900 text-slate-900 text-slate-900 text-slate-900`}>
                  ...
                  <div className="space-y-1.5 md:space-y-3 font-bold text-slate-900 text-slate-900 text-slate-900">
                    <div className="flex justify-between text-[10px] md:text-sm opacity-80 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900"><span>На 100км:</span><span>{truckSubMode === 'REMOT' ? `${truckSummary.qG_result} ${gasUnit}` : `${truckSummary.qD_result}л + ${truckSummary.qG_result}${gasUnit}`}</span></div>
                    <div className="flex justify-between text-[10px] md:text-sm opacity-80 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900"><span>Стоимость 1 км:</span><span>{truckSummary.kmG?.toFixed(2)} ₽</span></div>
                    <div className={`border-t ${truckTheme.border} pt-2 md:pt-3 flex justify-between font-bold ${truckTheme.textDark} text-sm md:text-2xl leading-none text-slate-900 text-slate-900 text-slate-900 text-slate-900`}>
                      <span className="text-[8px] md:text-xs uppercase self-center font-bold tracking-tighter text-slate-900 text-slate-900 text-slate-900 text-slate-900">ИТОГО ЗА ГОД:</span>
                      <span className="font-black text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900">{formatMoney(truckSummary.totalG)}</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="bg-slate-100 p-3 md:p-6 rounded-xl md:rounded-[2.5rem] border border-slate-200 font-bold text-slate-900 text-slate-900 text-slate-900 text-slate-900">
                <h4 className="text-[8px] md:text-[10px] font-bold text-slate-500 uppercase mb-2 md:mb-6 flex items-center gap-2 tracking-widest font-sans text-slate-500 text-slate-500 text-slate-500 text-slate-500 text-slate-500 text-slate-500 text-slate-500"><BarChart3 size={12}/> Структура затрат</h4>
                <div className="h-6 md:h-10 w-full bg-slate-300 rounded-lg md:rounded-2xl overflow-hidden flex shadow-inner text-slate-900">
                  {truckSubMode === 'REMOT' ? (<div className={`${truckTheme.button} h-full w-full text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900`}></div>) : (
                    <>
                ...
                <div className="flex justify-between mt-2 text-[8px] md:text-[10px] font-bold uppercase tracking-tight text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900">
                  {truckSubMode === 'REMOT' ? (<span className={`${truckTheme.textDark} font-bold text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900`}>100% {gasNameStr} Метан</span>) : (
                    <>
                      <span className="text-red-700 font-bold text-red-700 text-red-700 text-red-700 text-red-700 text-red-700">ДИЗЕЛЬ: {formatMoney(truckSummary.totalG * (1 - truckInputs.substitutionRate/100))}</span>
                      <span className={`${truckTheme.textDark} font-bold text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900`}>{gasNameStr}: {formatMoney(truckSummary.totalG * (truckInputs.substitutionRate/100))}</span>
                    </>
                  )}
                </div>
              </div>
