      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-2 md:p-4 font-sans text-slate-900 relative overflow-hidden">
        <div className="max-w-xl w-full relative z-10 flex flex-col items-center">
          <div className="bg-white/80 backdrop-blur-md p-6 rounded-[2rem] border border-slate-200 shadow-sm flex items-center justify-center mb-4 md:mb-8 w-full">
            <h2 className="text-slate-400 font-bold uppercase tracking-widest">EliteGas</h2>
          </div>
          ...
          <div className="grid grid-cols-1 gap-2 md:gap-4 w-full">
            ...
            >
              ...
              <div className="flex flex-col items-center md:items-start overflow-hidden">
                <h3 className="text-xl font-bold text-slate-900 mb-0.5 whitespace-nowrap leading-none">Для легкового ТС</h3>
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center p-1 md:p-8 font-sans overflow-x-hidden text-slate-900">
        <div className="w-full max-w-lg lg:max-w-4xl flex flex-col gap-1 md:gap-3">
          <header className="flex flex-col items-center text-center bg-white py-1.5 md:py-6 px-4 rounded-2xl shadow-sm border border-slate-200 w-full relative mt-0 md:mt-2">
            <button onClick={() => window.history.back()} className="absolute left-2 top-2 md:left-3 md:top-4 p-2 text-slate-600 hover:bg-slate-50 rounded-full transition-colors"><ChevronLeft size={20} className="md:w-6 md:h-6" /></button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-1 md:gap-3 w-full mb-1 md:mb-3">
            {/* БЕНЗИН */}
                  ...
                  <div className="space-y-2 md:space-y-4">
                      ...
                      <div className="flex items-end justify-between border-t border-slate-100 pt-2 md:pt-3">
                         ...
                         <div className="flex flex-col text-right">
                            <p className="text-[9px] md:text-[10px] font-bold text-slate-400 uppercase mb-0.5 leading-none">1 км пробега</p>
                            <p className="text-lg md:text-xl font-bold text-slate-600 leading-none">{passResults.kmCostB} Р/км</p>
                         </div>
                      </div>
                  </div>
                </div>
                <p className="text-[10px] md:text-[11px] font-semibold text-slate-400 pt-1.5 border-t border-slate-100 mt-2 md:mt-4 text-center italic leading-none">Эталон для сравнения</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-2 md:p-5 shadow-sm border-t-4 border-emerald-500 bg-emerald-50/30 flex flex-col justify-between">
                <div>
                  ...
                  <div className="space-y-2 md:space-y-4">
                      <div className="flex justify-between items-center bg-white p-1.5 md:p-2 rounded-xl border border-emerald-100">
                          ...
                          <div className="flex items-baseline gap-1">
                              <input type="number" name="pricePropane" value={passInputs.pricePropane} onChange={handlePassInputChange} className="w-14 bg-transparent text-right font-bold text-lg outline-none" />
                ...
                <p className="text-[10px] md:text-[12px] font-bold text-emerald-600 pt-1.5 border-t border-emerald-200 mt-2 md:mt-4 text-center tracking-tight leading-none">Экономия в год: +{formatMoney(passResults.saveYearP)}</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-2 md:p-5 shadow-sm border-t-4 border-blue-500 bg-blue-50/30 flex flex-col justify-between">
                ...
                <p className="text-[10px] md:text-[12px] font-bold text-blue-600 pt-1.5 border-t border-blue-200 mt-2 md:mt-4 text-center tracking-tight leading-none">Экономия в год: +{formatMoney(passResults.saveYearM)}</p>
            </div>
          </div>
          ...
          <div className="mt-auto">
            <div className="flex items-center justify-center gap-2 text-[10px] md:text-[11px] text-slate-900 font-bold bg-white px-4 py-2 rounded-full border shadow-sm mx-auto w-fit mb-4">
                ...
                <button onClick={() => setIsPassSettingsOpen(true)} className="p-1 hover:bg-slate-100 rounded-lg transition-colors"><Settings size={14} /></button>
            </div>
            <AppFooter />
          </div>
        </div>
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 font-sans text-slate-900">
        <div className="max-w-4xl w-full">
          <button onClick={() => window.history.back()} className="flex items-center gap-1 mb-6 font-bold text-sm hover:opacity-70"><ChevronLeft size={20} /> Назад</button>
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col p-2 font-sans text-slate-900">
        <div className="flex-1 flex flex-col items-center justify-center max-w-xl mx-auto w-full">
          <button onClick={() => window.history.back()} className="flex items-center gap-1 mb-4 self-start font-bold text-xs"><ChevronLeft size={18} /> Назад</button>
      ...
      <div className="min-h-screen bg-slate-50 p-1.5 md:p-8 font-sans text-slate-900 overflow-x-hidden">
        <div className="max-w-6xl mx-auto">
          <header className="mb-2 md:mb-4 flex items-center justify-between print-hidden">
            <button onClick={() => window.history.back()} className="flex items-center gap-1 px-4 py-2 bg-white border border-slate-300 rounded-xl text-xs font-bold text-slate-800 shadow-sm"><ChevronLeft size={14} /> Назад</button>
            <button onClick={() => window.print()} className="flex items-center gap-2 px-5 py-2 bg-white border border-slate-300 rounded-xl text-sm font-bold text-slate-900 shadow-sm"><Printer size={16} /> Печать</button>
          </header>
          ...
          <div className="bg-white p-3 md:p-10 rounded-2xl md:rounded-[2.5rem] shadow-sm border border-slate-200 relative overflow-hidden">
            <div className="relative z-10">
              ...
              <div className={`grid grid-cols-1 ${systemType === 'cng' ? 'md:grid-cols-2' : ''} gap-2 md:gap-6 mb-3 md:mb-8`}>
                ...
                {systemType === 'cng' && (
                  <div className="bg-white border-2 border-blue-100 p-4 md:p-8 rounded-2xl md:rounded-[2rem] shadow-lg flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative z-10 w-2/3 md:w-3/4 mt-2 font-bold">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-6 mb-3 md:mb-8 font-bold">
                ...
                <div className={`border ${truckTheme.border} rounded-xl md:rounded-[2rem] p-3 md:p-6 ${truckTheme.bg}/30`}>
                  ...
                  <div className="space-y-1.5 md:space-y-3 font-bold">
              ...
              <div className="bg-slate-100 p-3 md:p-6 rounded-xl md:rounded-[2.5rem] border border-slate-200 font-bold">
                ...
                <div className="flex justify-between mt-2 text-[8px] md:text-[10px] font-bold uppercase tracking-tight">
                  {truckSubMode === 'REMOT' ? (<span>100% {gasNameStr} Метан</span>) : (
                    <>
                      <span className="text-red-700">ДИЗЕЛЬ: {formatMoney(truckSummary.totalG * (1 - truckInputs.substitutionRate/100))}</span>
                      <span className={truckTheme.textDark}>{gasNameStr}: {formatMoney(truckSummary.totalG * (truckInputs.substitutionRate/100))}</span>
                    </>
                  )}
                </div>
              </div>
