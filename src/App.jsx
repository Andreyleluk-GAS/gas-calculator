...
const App = () => {
  ...
  if (currentScreen === 'PASSENGER_CALC') {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center p-1 md:p-8 font-sans overflow-x-hidden text-slate-900">
        <div className="w-full max-w-lg lg:max-w-4xl flex flex-col gap-2 md:gap-3 text-slate-900">
          ...
          <section className="grid grid-cols-2 gap-2 md:gap-3 w-full text-slate-900">
            <div className="bg-white p-2 md:p-4 rounded-xl shadow-sm border border-slate-200">
                ...
                <div className="relative">
                   <input type="number" name="mileage" value={passInputs.mileage} onChange={handlePassInputChange} className="w-full text-base md:text-xl font-bold p-1 bg-slate-50 rounded-lg outline-none focus:ring-2 focus:ring-blue-200 text-slate-900" />
            ...
            <div className="bg-white p-2 md:p-4 rounded-xl shadow-sm border border-slate-200 text-slate-900">
                ...
                <div className="relative">
                    <input type="number" name="fuelNorm" value={passInputs.fuelNorm} onChange={handlePassInputChange} className="w-full text-base md:text-xl font-bold p-1 bg-slate-50 rounded-lg outline-none focus:ring-2 focus:ring-blue-200 text-slate-900" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 md:gap-3 w-full mb-3 text-slate-900">
                  ...
                  <div className="space-y-2 md:space-y-3">
                      <div className="flex justify-between items-center bg-slate-50 p-1.5 md:p-2 rounded-xl border border-slate-100 text-slate-900">
                          ...
                          <div className="flex items-baseline gap-1">
                              <input type="number" name="priceBenzin" value={passInputs.priceBenzin} onChange={handlePassInputChange} className="w-14 bg-transparent text-right font-bold text-base md:text-lg outline-none text-slate-900" />
                              <span className="text-[10px] font-bold text-slate-400">₽</span>
                          </div>
                      </div>
                      <div className="flex justify-between items-center px-1 border-b border-slate-50 pb-1">
                          <p className="text-[9px] md:text-[10px] font-bold text-slate-400 uppercase">Стоимость 1 км</p>
                          <p className="text-sm font-bold text-slate-600">{passResults.kmCostB} Р/км</p>
                      </div>
                      <div className="flex justify-between items-end">
                          <p className="text-[9px] md:text-[10px] font-bold text-slate-400 uppercase mb-0.5">Затраты / мес</p>
                          <p className="text-xl md:text-2xl font-black leading-none text-slate-900">{formatMoney(passResults.costB)}</p>
                      </div>
                  </div>
                </div>
                <p className="text-[9px] md:text-[10px] font-semibold text-slate-400 pt-2 border-t border-slate-100 mt-3 md:mt-4 text-center italic leading-none">Эталон для сравнения</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-2.5 md:p-5 shadow-sm border-t-4 border-emerald-500 bg-emerald-50/30 flex flex-col justify-between">
                  ...
                  <div className="space-y-2 md:space-y-3">
                      <div className="flex justify-between items-center bg-white p-1.5 md:p-2 rounded-xl border border-emerald-100 text-slate-900">
                          ...
                          <div className="flex items-baseline gap-1 text-slate-900">
                              <input type="number" name="pricePropane" value={passInputs.pricePropane} onChange={handlePassInputChange} className="w-14 bg-transparent text-right font-bold text-base md:text-lg outline-none text-slate-900" />
                              <span className="text-[10px] font-bold text-emerald-600 text-slate-900">₽</span>
                          </div>
                      </div>
                      <div className="flex justify-between items-center px-1 border-b border-emerald-100/50 pb-1">
                          <p className="text-[9px] md:text-[10px] font-bold text-emerald-800/60 uppercase">Стоимость 1 км</p>
                          <p className="text-sm font-bold text-emerald-700">{passResults.kmCostP} Р/км</p>
                      </div>
                      <div className="flex justify-between items-end">
                ...
                <p className="text-[9px] md:text-[11px] font-bold text-emerald-600 pt-2 border-t border-emerald-200 mt-3 md:mt-4 text-center tracking-tight leading-none">Экономия в год: +{formatMoney(passResults.saveYearP)}</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-2.5 md:p-5 shadow-sm border-t-4 border-blue-500 bg-blue-50/30 flex flex-col justify-between text-slate-900">
                <div>
                  ...
                  <div className="space-y-2 md:space-y-3">
                      ...
                      <div className="flex justify-between items-center px-1 border-b border-blue-100/50 pb-1 text-slate-900">
                          <p className="text-[9px] md:text-[10px] font-bold text-blue-800/60 uppercase">Стоимость 1 км</p>
                          <p className="text-sm font-bold text-blue-700">{passResults.kmCostM} Р/км</p>
                      </div>
                      <div className="flex justify-between items-end">
                ...
                <p className="text-[9px] md:text-[11px] font-bold text-blue-600 pt-2 border-t border-blue-200 mt-3 md:mt-4 text-center tracking-tight leading-none">Экономия в год: +{formatMoney(passResults.saveYearM)}</p>
            </div>
          </div>
        ...
        <div className="max-w-4xl w-full text-slate-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8 text-slate-900 text-slate-900">
            ...
            <div onClick={() => { setTruckSubMode('REMOT'); navigateTo('TRUCK_INPUTS'); }} className="bg-white p-6 rounded-[2rem] border-2 border-slate-100 hover:border-amber-400 cursor-pointer shadow-sm transition-all group text-slate-900">
              ...
              <h3 className="text-xl font-bold mb-1 text-slate-800 tracking-tight text-slate-900">Ремоторизация ТС</h3>
              ...
              <div className={`grid ${!isRem ? 'grid-cols-2' : 'grid-cols-1'} gap-3 text-slate-900 text-slate-900`}>
                ...
                {!isRem && (
                  <div>
                    ...
                    <input type="number" name="substitutionRate" value={truckInputs.substitutionRate} onChange={(e) => handleTruckInputChange(e, false)} className="w-full p-3 border border-slate-300 rounded-xl font-bold text-sm text-blue-700 text-blue-700" />
                  </div>
                )}
              </div>
  ...
  if (currentScreen === 'TRUCK_REPORT') {
    return (
      <div className="min-h-screen bg-slate-50 p-1.5 md:p-8 font-sans text-slate-900 overflow-x-hidden text-slate-900">
        <div className="max-w-6xl mx-auto text-slate-900 text-slate-900">
          <header className="mb-2 md:mb-4 flex items-center justify-between print-hidden">
            ...
            <button onClick={() => window.print()} className="hidden md:flex items-center gap-2 px-5 py-2 bg-white border border-slate-300 rounded-xl text-sm font-bold text-slate-900 shadow-sm font-sans text-slate-900"><Printer size={16} /> Печать</button>
          </header>
          ...
          <div className="bg-white p-3 md:p-10 rounded-2xl md:rounded-[2.5rem] shadow-sm border border-slate-200 relative overflow-hidden text-slate-900">
            ...
            <div className="relative z-10 text-slate-900 text-slate-900">
              <div className="mb-3 md:mb-8 text-center border-b border-slate-100 pb-2 md:pb-6 font-sans">
                <h1 className="text-sm md:text-2xl font-bold uppercase tracking-tight leading-tight text-slate-900 text-slate-900">
                  {truckSubMode === 'REMOT' ? (
                      `Отчет: Ремоторизация (100% ${systemType === 'cng' ? 'КПГ' : 'СПГ'})`
                  ) : (
                      `Отчет: Газодизель (ДТ ${100 - truckInputs.substitutionRate}% + ${systemType === 'cng' ? 'КПГ' : 'СПГ'} ${truckInputs.substitutionRate}%)`
                  )}
                </h1>
              ...
              <div className={`grid grid-cols-1 ${systemType === 'cng' ? 'md:grid-cols-2' : ''} gap-2 md:gap-6 mb-3 md:mb-8 font-sans`}>
                <div className={`bg-gradient-to-br ${truckTheme.gradient} text-white p-4 md:p-8 rounded-2xl md:rounded-[2rem] shadow-xl flex flex-row justify-between relative overflow-hidden font-sans text-white`}>
                  <div className="relative z-10 flex flex-col justify-between w-2/3 md:w-3/4 text-white text-white">
                    <div><div className="text-[9px] md:text-xs font-bold uppercase tracking-wider opacity-90 text-white text-white">Экономия (Базовый)</div><div className="text-xl md:text-5xl font-bold mb-2 md:mb-4 leading-tight font-sans text-white text-white">{formatMoney(truckSummary.savings)}</div></div>
                    <div className="flex gap-2 md:gap-3 flex-wrap text-white text-white"><div className="bg-white/20 px-2 py-0.5 md:px-3 md:py-1.5 rounded-lg text-[8px] md:text-[10px] font-bold uppercase text-white">{formatMoney(truckSummary.monthlySav)} / мес</div><div className="bg-white/20 px-2 py-0.5 md:px-3 md:py-1.5 rounded-lg text-[8px] md:text-[10px] font-bold uppercase font-sans text-white text-white">- {Math.round((truckSummary.savings / (truckSummary.totalD || 1)) * 100)}% затрат</div></div>
                  </div>
                  <div className="absolute right-[10px] top-[10px] bottom-[10px] flex items-center justify-end w-2/5 md:w-1/3 select-none text-white text-white">
                    <img src="/logo.png" alt="Logo" className="h-full w-auto object-contain object-right opacity-30 text-white text-white" onError={(e)=>{e.target.style.display='none'}} />
                  </div>
                </div>
                {systemType === 'cng' && (
                  <div className="bg-white border-2 border-blue-100 p-4 md:p-8 rounded-2xl md:rounded-[2rem] shadow-lg flex flex-col justify-between relative overflow-hidden text-slate-900 font-sans text-slate-900 text-slate-900">
                    ...
                    <div className="relative z-10 w-2/3 md:w-3/4 mt-2 font-bold text-slate-900 text-slate-900">
                        ...
                        <div className="flex gap-2 md:gap-3 flex-wrap text-slate-900 text-slate-900"><div className="bg-blue-50 text-blue-900 px-2 py-0.5 md:px-3 md:py-1.5 rounded-lg text-[8px] md:text-[10px] font-bold border border-blue-200 uppercase font-sans text-blue-900 text-blue-900">{formatMoney(truckSummary.monthlySavDiscounted)} / мес</div><div className="bg-blue-50 text-blue-900 px-2 py-0.5 md:px-3 md:py-1.5 rounded-lg text-[8px] md:text-[10px] font-bold border border-blue-200 uppercase font-sans text-blue-900 text-blue-900">- {Math.round((truckSummary.savingsDiscounted / (truckSummary.totalD || 1)) * 100)}% затрат</div></div>
                    </div>
                    <div className="absolute right-[10px] bottom-[10px] flex items-end justify-end max-h-[35%] w-[28%] select-none opacity-40 text-slate-900">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-6 mb-3 md:mb-8 font-sans font-bold text-slate-900 text-slate-900">
                <div className="border border-red-200 rounded-xl md:rounded-[2rem] p-3 md:p-6 bg-red-50/30 text-slate-900 text-slate-900">
                  <div className="text-red-900 font-bold text-[10px] md:text-xs uppercase mb-2 md:mb-4 flex items-center gap-2 font-sans text-red-900"><Fuel size={12}/> На дизеле (100%)</div>
                  <div className="space-y-1.5 md:space-y-3 text-slate-900">
                    <div className="flex justify-between text-[10px] md:text-sm font-bold opacity-80 text-slate-900 text-slate-900"><span>Расход на 100км:</span><span>{truckSummary.qD_base} л</span></div>
                    <div className="flex justify-between text-[10px] md:text-sm font-bold opacity-80 text-slate-900 text-slate-900 text-slate-900"><span>Стоимость 1 км:</span><span>{truckSummary.kmD?.toFixed(2)} ₽</span></div>
                ...
                <div className={`border ${truckTheme.border} rounded-xl md:rounded-[2rem] p-3 md:p-6 ${truckTheme.bg}/30 text-slate-900 text-slate-900 text-slate-900`}>
                  ...
                  <div className="space-y-1.5 md:space-y-3 font-bold text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900">
                    <div className="flex justify-between text-[10px] md:text-sm opacity-80 text-slate-900 text-slate-900 text-slate-900"><span>На 100км:</span><span>{truckSubMode === 'REMOT' ? `${truckSummary.qtyG_res} ${gasUnit}` : `${truckSummary.qD_result}л + ${truckSummary.qG_result}${gasUnit}`}</span></div>
                    <div className="flex justify-between text-[10px] md:text-sm opacity-80 text-slate-900 text-slate-900 text-slate-900"><span>Стоимость 1 км:</span><span>{truckSummary.kmG?.toFixed(2)} ₽</span></div>
                    <div className={`border-t ${truckTheme.border} pt-2 md:pt-3 flex justify-between font-bold ${truckTheme.textDark} text-sm md:text-2xl leading-none text-slate-900 text-slate-900 text-slate-900`}>
                      <span className="text-[8px] md:text-xs uppercase self-center font-bold tracking-tighter text-slate-900 text-slate-900 text-slate-900">ИТОГО ЗА ГОД:</span>
                      <span className="font-black text-slate-900 text-slate-900">{formatMoney(truckSummary.totalG)}</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="bg-slate-100 p-3 md:p-6 rounded-xl md:rounded-[2rem] border border-slate-200 font-bold text-slate-900 text-slate-900 text-slate-900">
                ...
                <div className="h-6 md:h-10 w-full bg-slate-300 rounded-lg md:rounded-2xl overflow-hidden flex shadow-inner text-slate-900 text-slate-900">
                  {truckSubMode === 'REMOT' ? (<div className={`${truckTheme.button} h-full w-full text-slate-900 text-slate-900`}></div>) : (
                    <>
                      <div className="bg-red-600 h-full transition-all duration-1000 text-slate-900 text-slate-900" style={{ width: `${(100 - truckInputs.substitutionRate)}%` }}></div>
                      <div className={`${truckTheme.button} h-full transition-all duration-1000 text-slate-900 text-slate-900`} style={{ width: `${truckInputs.substitutionRate}%` }}></div>
                    </>
                  )}
                </div>
                <div className="flex justify-between mt-2 text-[8px] md:text-[10px] font-bold uppercase tracking-tight text-slate-900 text-slate-900 text-slate-900 text-slate-900">
                  {truckSubMode === 'REMOT' ? (<span className={`${truckTheme.textDark} font-bold text-slate-900 text-slate-900 text-slate-900`}>100% {gasName} Метан</span>) : (
                    <>
                      <span className="text-red-700 font-bold text-red-700 text-red-700 text-red-700 text-red-700">ДИЗЕЛЬ: {formatMoney(truckSummary.totalG * (1 - truckInputs.substitutionRate/100))}</span>
                      <span className={`${truckTheme.textDark} font-bold text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900`}>{gasName}: {formatMoney(truckSummary.totalG * (truckInputs.substitutionRate/100))}</span>
                    </>
                  )}
                </div>
              </div>
