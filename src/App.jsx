...
const App = () => {
            ...
            <div className="bg-white rounded-2xl p-2 md:p-5 shadow-sm border-t-4 border-emerald-500 bg-emerald-50/30 flex flex-col justify-between text-slate-900">
                <div>
                  <div className="flex items-center gap-2 mb-1.5 md:mb-4">
                      ...
                      <h3 className="text-xs font-bold uppercase tracking-wider text-emerald-900 text-emerald-900">Пропан</h3>
                  </div>
                  <div className="space-y-2 md:space-y-4 text-slate-900 text-slate-900">
                      ...
                      <div className="flex items-end justify-between border-t border-emerald-100/50 pt-2 md:pt-3 text-slate-900">
                         ...
                         <div className="flex flex-col text-right">
                            <p className="text-[9px] md:text-[10px] font-bold text-emerald-800/60 uppercase mb-0.5 leading-none text-emerald-800">1 км пробега</p>
                            <p className="text-lg md:text-xl font-bold text-emerald-700 leading-none text-emerald-700">{passResults.kmCostP} Р/км</p>
                         </div>
                      </div>
                  </div>
                </div>
                <p className="text-[10px] md:text-[12px] font-bold text-emerald-600 pt-1.5 border-t border-emerald-200 mt-2.5 md:mt-4 text-center tracking-tight leading-none text-center text-emerald-600 text-emerald-600">Экономия в год: +{formatMoney(passResults.saveYearP)}</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-2 md:p-5 shadow-sm border-t-4 border-blue-500 bg-blue-50/30 flex flex-col justify-between text-slate-900 text-slate-900 text-slate-900">
                <div>
                  <div className="flex items-center gap-2 mb-1.5 md:mb-4">
                      ...
                      <h3 className="text-xs font-bold uppercase tracking-wider text-blue-900 text-blue-900">Метан</h3>
                  </div>
                  <div className="space-y-2 md:space-y-4 text-slate-900 text-slate-900 text-slate-900">
                      <div className="flex justify-between items-center bg-white p-1.5 md:p-2 rounded-xl border border-blue-100 text-slate-900">
                          <label className="text-[9px] md:text-[10px] font-bold text-blue-800 uppercase text-blue-800 text-blue-800">Цена / м³</label>
                          <div className="flex items-baseline gap-1 text-slate-900">
                      ...
                      <div className="flex items-end justify-between border-t border-blue-100/50 pt-2 md:pt-3 text-slate-900 text-slate-900">
                         <div className="flex flex-col text-slate-900">
                            <p className="text-[9px] md:text-[10px] font-bold text-blue-800/60 uppercase mb-0.5 leading-none text-blue-800">Затраты / мес</p>
                            <p className="text-2xl md:text-3xl font-black text-blue-900 text-blue-900 leading-none">{formatMoney(passResults.costM)}</p>
                         </div>
                         <div className="flex flex-col text-right">
                            <p className="text-[9px] md:text-[10px] font-bold text-blue-800/60 uppercase mb-0.5 leading-none text-blue-800">1 км пробега</p>
                            <p className="text-lg md:text-xl font-bold text-blue-700 text-blue-700 leading-none">{passResults.kmCostM} Р/км</p>
                         </div>
                      </div>
                  </div>
                </div>
                <p className="text-[10px] md:text-[12px] font-bold text-blue-600 pt-1.5 border-t border-blue-200 mt-2.5 md:mt-4 text-center tracking-tight leading-none text-center text-blue-600 text-blue-600 text-blue-600">Экономия в год: +{formatMoney(passResults.saveYearM)}</p>
            </div>
          </div>
  ...
  if (currentScreen === 'TRUCK_HOME') {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 font-sans text-slate-900 text-slate-900 text-slate-900 text-slate-900 text-slate-900">
        <div className="max-w-4xl w-full text-slate-900 text-slate-900">
          <button onClick={() => window.history.back()} className="hidden md:flex items-center gap-1 mb-6 text-slate-900 font-bold text-sm hover:opacity-70 text-slate-900">
            <ChevronLeft size={20} />
            <span>Назад</span>
          </button>
      ...
      <div className="min-h-screen bg-slate-50 p-1.5 md:p-8 font-sans text-slate-900 overflow-x-hidden text-slate-900 text-slate-900 text-slate-900 text-slate-900">
        <div className="max-w-6xl mx-auto text-slate-900 text-slate-900 text-slate-900 text-slate-900">
          ...
          <div className="bg-white p-3 md:p-10 rounded-2xl md:rounded-[2.5rem] shadow-sm border border-slate-200 relative overflow-hidden text-slate-900 text-slate-900 text-slate-900">
             {/* Фоновый логотип удален */}
            <div className="relative z-10 text-slate-900 text-slate-900 text-slate-900">
              <div className="mb-3 md:mb-8 text-center border-b border-slate-100 pb-2 md:pb-6 font-sans text-slate-900 text-slate-900">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-6 mb-3 md:mb-8 font-sans font-bold text-slate-900 text-slate-900">
                ...
                <div className={`border ${truckTheme.border} rounded-xl md:rounded-[2rem] p-3 md:p-6 ${truckTheme.bg}/30 text-slate-900 text-slate-900`}>
                  ...
                  <div className="space-y-1.5 md:space-y-3 font-bold text-slate-900 text-slate-900">
                    <div className="flex justify-between text-[10px] md:text-sm opacity-80 text-slate-900 text-slate-900"><span>На 100км:</span><span>{truckSubMode === 'REMOT' ? `${truckSummary.qG_result} ${gasUnit}` : `${truckSummary.qD_result}л + ${truckSummary.qG_result}${gasUnit}`}</span></div>
